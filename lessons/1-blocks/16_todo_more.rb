...
# ------------------------------------------------------------------------------
# p list.find_by_title("roOm") # object or nil
# ------------------------------------------------------------------------------
# todo1.done!
# p list.all_done # new TodoList object or nil
# # ------------------------------------------------------------------------------
# p list.all_not_done # new TodoList object or nil
# # ------------------------------------------------------------------------------
# p list.mark_done('room')	# takes a string as argument, and marks the first Todo object that matches the argument as done.
# p list.mark_all_done
# todo2.done!	# mark every todo as done
# puts list
# p list.mark_all_undone	# mark every todo as not done
# puts list
